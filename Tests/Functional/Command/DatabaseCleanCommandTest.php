...
use Recognize\FilemanagerBundle\Command\DatabaseCleanCommand;
...
class DatabaseCleanCommandTest extends KernelAndFilesystemTestCase {
    ...
    public function testCommandWithoutErrors() {
        $command = $this->application->find("filemanager:database:clean");
    ...
    public function testActualDeleting(){
        $this->fillTempDir();
        ...
        $this->assertTrue( strpos($output, "Deleting directory ") !== false );
        $this->assertTrue( strpos($output, "Deleting file ") !== false );
    }
    ...
    protected function getCommand(){
        $command = new DatabaseCleanCommand();
